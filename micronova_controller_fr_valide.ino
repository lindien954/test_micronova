...
#define fumesTempAddr 0x5A  //0x3E
#define fumeSpeedAddr 0x37
#define flamePowerAddr 0x34

uint8_t stoveState, tempSet, pwrSet, fumesTemp, flamePower;
...
void reconnect() //Connect to MQTT server
{
    ...
    if (client.connected())
    {
      ...
      String setconsigne_sensor_payload = "{\"name\": \"Temperature\", \"state_topic\": \"" Setconsigne_topic "\", \"qos\": 0, \"device_class\": \"temperature\", \"state_class\": \"measurement\", \"unit_of_measurement\": \"°C\", \"icon\": \"mdi:thermometer\", \"unique_id\": \"9db3245e-6ace-4d14-ac07-844cd68d245c\",\"device\": " device_information "}";
...
void getStates() //Calls all the get…() functions
{
    ...
    delay(100);
    getTempSet(); //Consigne Temperature
    delay(100);
    getPwrSet();
    delay(100);
    getFumeTemp();
